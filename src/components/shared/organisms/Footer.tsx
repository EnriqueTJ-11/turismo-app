        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-10">
          ...
          <span className="text-xl font-bold text-white">Amaturis</span>
            ...
            <p className="text-slate-400 leading-relaxed max-w-md">
              Impulsamos el turismo sostenible y la conservación de la región amazónica de Colombia.
              Te conectamos con experiencias locales auténticas.
            </p>
            <div className="flex gap-3">
              <a className="h-10 w-10 rounded-full bg-white/5 hover:bg-white/10 flex items-center justify-center transition-colors" href="#">
